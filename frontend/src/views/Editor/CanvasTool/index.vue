<template>
  <div class="canvas-tool">
      ...
      <div class="insert-handler-item group-btn" v-tooltip="'插入图片'">
        ...
        <Popover trigger="click" v-model:value="imageMenuVisible" style="height: 100%;" :offset="10">
          <template #content>
            ...
            <PopoverMenuItem center @click="aiImageDialogVisible = true; imageMenuVisible = false"><i-icon-park-outline:magic class="icon" /> AI 生图</PopoverMenuItem>
          </template>
          <span class="arrow"><i-icon-park-outline:down /></span>
        </Popover>
      </div>
    ...
    <Modal v-model:visible="aiImageDialogVisible" :width="460">
      <AIImageDialog
        mode="insert"
        @confirm="url => { createImageElement(url); aiImageDialogVisible = false }"
